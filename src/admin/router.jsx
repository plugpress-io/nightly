	...
	return (
		<div className="min-h-screen bg-[#f6f6f7]">
			...
			<div className="bg-white border-b border-gray-200">
				<div className="mx-auto px-6 py-3" style={{ maxWidth: '950px' }}>
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-2.5">
							<svg width="28" height="28" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
								<path d="M60 0H36C16.1177 0 0 16.1177 0 36V60C0 79.8822 16.1177 96 36 96H60C79.8822 96 96 79.8822 96 60V36C96 16.1177 79.8822 0 60 0Z" fill="url(#paint0_linear_1026_82)"/>
			...
			{/* Content */}
			<div className="mx-auto px-6 pt-20 pb-8" style={{ maxWidth: '950px', minWidth: '860px' }}>
				<Settings />
			</div>
		</div>
	);
