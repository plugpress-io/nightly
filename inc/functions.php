 ...
 * Color Scheme
 */
function wp_nightly_color_scheme( $json = false ) {
    $colors = [
        'black'  => [
            'body'   => '#1C1B1E',
            'texts'  => '#A1A1A1',
...
function wp_nightly_options( $json = false ) {
    ...
    $all_options = [
        ...
        'schedule_type'           => get_option( $prefix . "_schedule_type" ),
        'schedule_time'           => get_option( $prefix . "_schedule_time" ),
        'schedule_time_start'     => get_option( $prefix . "_schedule_time_start" ),
        'schedule_time_end'       => get_option( $prefix . "_schedule_time_end" ),
        ...
        //Frontend: color
        'color_scheme'            => get_option( $prefix . "_color_scheme " ),
        'colors'                  => wp_nightly_color_scheme( $json ),
