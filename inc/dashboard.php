...
class Dashboard {
    ...
    public function add_menu() {
        ...
        $page = add_submenu_page( 'wp-nightly', __( 'WP Nightly', 'wp-nightly' ), __( 'Settings', 'wp-nightly' ), 'edit_pages', 'wp_nightly', [$this, 'config_page'] );
    ...
    public function scripts() {
        ...
        wp_enqueue_style(
            'wp-nightly-styles',
            WP_NIGHTLY_PLUGIN_DIST . '/style-dashboard.css',
            ['wp-components'],
            WP_NIGHTLY_VERSION
        );
        ...
        wp_enqueue_style(
            'wp-nightly-main',
            WP_NIGHTLY_PLUGIN_DIST . '/dashboard.css',
            [],
            WP_NIGHTLY_VERSION
        );
        ...
        wp_enqueue_script(
            'wp-nightly-scripts',
            WP_NIGHTLY_PLUGIN_DIST . '/dashboard.js',
