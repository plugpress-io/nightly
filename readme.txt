...
Add a professional dark mode toggle to your WordPress site. Works with any theme - FSE or classic. Lightweight, accessible, and user-friendly.
...
1. **Admin Dashboard** - Clean, intuitive settings interface for both FSE and classic themes
2. **Floating Toggle** - Professional floating toggle in action on a live website
3. **Gutenberg Block** - Easy-to-use block editor integration with customization options
4. **Dark Mode Active** - Beautiful dark mode transformation of a typical WordPress site
5. **Mobile Responsive** - Perfect appearance and functionality on all device sizes
6. **Accessibility Features** - Keyboard navigation and screen reader compatibility in action
...
= 1.0.0 =
Initial release of Nightly - the professional dark mode solution for WordPress. Install now to give your visitors the modern dark mode experience they expect.
...
Visit [plugpress.io](https://plugpress.io/) for additional resources and premium support options.
